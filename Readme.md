# Run Playwright Accessibility Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Playwright accessibility tests using the TestMu AI Accessibility Tool. This sample shows how to configure Playwright + TestMu AI Accessibility to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/lambdatest-accessibility-playwright && cd lambdatest-accessibility-playwright
npm install
```
